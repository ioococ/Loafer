...
public class userTable {
    ...
    public String RowJson(Connection con) throws SQLException {
        PreparedStatement Pstmt = null;
        String sql = "select id as id,username as username from usertable";
        Pstmt = con.prepareStatement(sql);
