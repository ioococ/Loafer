...
//	}
     ...
     * Create the frame.
     */
    public InputForm(JFrame pFrame) {
        setTitle("\u5165\u5E93\u7BA1\u7406\uFF1A");
        ...
        JLabel lblNewLabel_2 = new JLabel("\u5165\u5E93\u6D41\u6C34\u8868:");
        ...
        btnNewButton_1_2.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                InputForm.this.dispose();//关闭当前窗口
                InputForm.this.pFrame.setEnabled(true); //父窗口设为可以活动
                InputForm.this.pFrame.show();  //父窗口显示到顶层
            }
        });
        ...
        try {
            ...
            table.setModel(new DefaultTableModel(
                    itd.inputRowsDate(idb.con,Dp1.getText().trim(),Dp2.getText().trim()),
                    itd.intputColumn(idb.con)
            ));
        ...
        btnNewButton_1_3.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {//查找按钮
        ...
        lblNewLabel.setBounds(10, 10, 87, 31);
        ...
        JButton btn_Rk = new JButton("\u5165\u5E93\u5F55\u5165");
        btn_Rk.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) { //新增记录
                ...
                try {
                    ...
                    String Bz=itd.add(idb.con,Edit_Bh.getText().trim(),Edit_Mc.getText().trim(),Edit_Sl.getText().trim(),"",DLname);
                    if (!Bz.equals("-1")) {
        ...
        btn_Rk.setBounds(721, 6, 143, 39);
        panel.add(btn_Rk);
        btn_Rk.setFont(new Font("宋体", Font.PLAIN, 26));
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode()==KeyEvent.VK_ENTER) {
                    try {
                        ...
                        idb.CrateTable();//切换数据库
                        inputTableDao itd=new inputTableDao();
                        String WpName=itd.searchInput(idb.con,Edit_Bh.getText().trim());//按编号取一下名称
            ...
            public void focusLost(FocusEvent e) {
                ...
                try {
                    if (Edit_Mc.getText().trim().equals("")) {
                        ...
                        idb.CrateTable();//切换数据库
                        //inputTableDao itd=new inputTableDao();
                        String WpBh=itd.searchInputName(idb.con,Edit_Mc.getText().trim());
                        if (!WpBh.equals("")){
        ...
        InputForm.this.addWindowListener(this);
    }
